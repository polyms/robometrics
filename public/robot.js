(function () {
  ...
  */
  ...
  var AppContext = /*#__PURE__*/react.exports.createContext(null);
  var useAppContext = function useAppContext() {
    return react.exports.useContext(AppContext);
  };
  ...
  var NavItem = function NavItem(_ref) {
    ...
    return /*#__PURE__*/React.createElement("li", {
      ...
      className: "nav-link".concat(tab === activeTab ? ' active' : ''),
      "aria-current": "page",
      href: "#".concat(tab),
  ...
  var StatisticTable = function StatisticTable(_ref) {
    var data = _ref.data,
        info = _ref.info;
    var columns = react.exports.useMemo(function () {
      return [{
        Header: 'Type',
        accessor: 'nodeName'
      }, {
    ...
    var _useTable = reactTable.exports.useTable({
      columns: columns,
      data: data,
      initialState: {
        groupBy: ['nodeName'],
    ...
    }, reactTable.exports.useGroupBy, reactTable.exports.useSortBy, reactTable.exports.useExpanded),
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, /*#__PURE__*/React.createElement("table", _extends$1({
      className: "table mb-0"
    }, getTableProps()), /*#__PURE__*/React.createElement("caption", {
      className: "px-2 small"
    }, "".concat(info.generator, " - ").concat(info.generated)), /*#__PURE__*/React.createElement("thead", null, headerGroups.map(function (headerGroup) {
      return /*#__PURE__*/React.createElement("tr", headerGroup.getHeaderGroupProps(), headerGroup.headers.map(function (column) {
        return (
          ...
          React.createElement("th", column.getHeaderProps(column.getSortByToggleProps()), column.render('Header'), /*#__PURE__*/React.createElement("span", null, column.isSorted ? column.isSortedDesc ? '👇' : '👉' : ''))
        );
      }));
      ...
      return /*#__PURE__*/React.createElement("tr", row.getRowProps(), row.cells.map(function (cell) {
        return /*#__PURE__*/React.createElement("td", _extends$1({
          className: row.isExpanded ? 'table-primary text-primary text-uppercase fs-5 fw-bold' : ''
  ...
  var formatDuration = function formatDuration(dur) {
    var hours = (dur.hours || 0) < 10 ? "0".concat(dur.hours) : dur.hours;
    var minutes = (dur.minutes || 0) < 10 ? "0".concat(dur.minutes) : dur.minutes;
    var seconds = (dur.seconds || 0) < 10 ? "0".concat(dur.seconds) : dur.seconds;
    return [hours, minutes, seconds].join(':');
  };

  var _transitionStatusToCl;
  var transitionStatusToClassHash = (_transitionStatusToCl = {}, _defineProperty(_transitionStatusToCl, UNMOUNTED, 'collapse'), _defineProperty(_transitionStatusToCl, ENTERING, 'collapsing'), _defineProperty(_transitionStatusToCl, ENTERED, 'collapse show'), _defineProperty(_transitionStatusToCl, EXITING, 'collapsing'), _defineProperty(_transitionStatusToCl, EXITED, 'collapse'), _transitionStatusToCl);
  ...
  var Collapse = function Collapse(_ref) {
    ...
    var onEntering = react.exports.useCallback(function (node) {
      setHeight(getHeight(node));
    }, [setHeight]);
    var onEntered = react.exports.useCallback(function () {
      setHeight(null);
    }, [setHeight]);
    var onExit = react.exports.useCallback(function (node) {
      setHeight(getHeight(node));
    }, [setHeight]);
    var onExiting = react.exports.useCallback(function (node) {
      /* eslint-disable
  ...
  var ExpandButton = function ExpandButton(_ref2) {
    ...
    var _useState3 = react.exports.useState(true),
        ...
        setExpanded = _useState4[1]; // type === 'suite'


    return /*#__PURE__*/React.createElement("div", {
      className: "d-flex"
    }, /*#__PURE__*/React.createElement("button", {
      className: "btn btn-sm btn-outline-info py-0 px-1 me-1 align-self-start".concat(root ? ' pe-none' : ''),
      style: {
        borderStyle: 'dashed',
        lineHeight: '1.2'
      },
    ...
    }, root ? /*#__PURE__*/React.createElement(React.Fragment, null, "\xA0") : isExpanded ? '-' : '+'), /*#__PURE__*/React.createElement("div", {
      className: "flex-grow-1"
    }, /*#__PURE__*/React.createElement("h6", {
      className: "d-flex align-items-start ms-1"
    }, type && /*#__PURE__*/React.createElement("small", {
      className: "badge me-2 text-uppercase bg-".concat(color)
    }, type), name, critical && /*#__PURE__*/React.createElement("span", {
      className: "ms-2 badge bg-danger"
    }, "Critical")), /*#__PURE__*/React.createElement(Collapse, {
      isOpen: isExpanded
    }, children)));
  };
  ...
  var Keywords = function Keywords(_ref) {
    ...
    var data = react.exports.useMemo(function () {
      ...
      while (node) {
        ...
        var item = {
          ...
          status: (_node$lastElementChil = node.lastElementChild) === null || _node$lastElementChil === void 0 ? void 0 : _node$lastElementChil.getAttribute('status'),
          startTime: formatDateFrom((_node$lastElementChil2 = node.lastElementChild) === null || _node$lastElementChil2 === void 0 ? void 0 : _node$lastElementChil2.getAttribute('starttime')),
          endTime: formatDateFrom((_node$lastElementChil3 = node.lastElementChild) === null || _node$lastElementChil3 === void 0 ? void 0 : _node$lastElementChil3.getAttribute('endtime')),
          arguments: [],
          assigns: [],
          msgs: [],
          path: "".concat(path, "[").concat(list.length, "]")
        };
        ...
        if (item.library) {
          ...
          item.doc = (_node$firstElementChi = node.firstElementChild) === null || _node$firstElementChi === void 0 ? void 0 : _node$firstElementChi.textContent;
        }

        var assigns = doc.evaluate("".concat(path, "/assign/var"), doc);
        ...
        var args = doc.evaluate("".concat(path, "/arguments/arg"), doc);
        ...
        var msgs = doc.evaluate("".concat(path, "[").concat(list.length + 1, "]/msg"), doc);
        var msg = msgs.iterateNext();

        while (msg) {
          item.msgs.push({
            id: "".concat(path, "__msg__").concat(item.msgs.length),
    ...
    return data.map(function (x) {
      return /*#__PURE__*/React.createElement("div", {
        key: "".concat(path, "__").concat(x.id)
        ...
        className: "row border-start border-5 border-".concat(x.color)
      }, /*#__PURE__*/React.createElement("div", {
        className: "col-auto"
      }, /*#__PURE__*/React.createElement("dt", null, "Status"), /*#__PURE__*/React.createElement("dd", {
        className: "fw-bold text-".concat(STATUS_COLORS[x.status])
        ...
        return /*#__PURE__*/React.createElement("tr", {
          ...
          className: "fw-bold text-".concat(STATUS_COLORS[msg.level])
  ...
  var Log = function Log(_ref) {
    ...
    var data = React.useMemo(function () {
      ...
      while (node) {
        ...
        var item = {
          ...
          startTime: formatDateFrom((_node$lastElementChil2 = node.lastElementChild) === null || _node$lastElementChil2 === void 0 ? void 0 : _node$lastElementChil2.getAttribute('starttime')),
          endTime: formatDateFrom((_node$lastElementChil3 = node.lastElementChild) === null || _node$lastElementChil3 === void 0 ? void 0 : _node$lastElementChil3.getAttribute('endtime')),
          critical: ((_node$lastElementChil4 = node.lastElementChild) === null || _node$lastElementChil4 === void 0 ? void 0 : _node$lastElementChil4.getAttribute('critical')) === 'yes',
          tags: [],
          color: 'info'
        };
        item.path = path.replace('[@id]', "[@id=\"".concat(item.id, "\"]"));

        if (item.type !== 'suite') {
          item.color = STATUS_COLORS[item.status];
        }

        var tags = doc.evaluate("".concat(path, "/tags/tag"), doc);
    ...
    return data.map(function (x) {
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "col-auto"
      }, /*#__PURE__*/React.createElement("dt", null, "End time"), /*#__PURE__*/React.createElement("dd", null, x.endTime)), !!x.tags.length && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
        className: "fw-bold"
      }, "Tags: "), x.tags.join(', '))), /*#__PURE__*/React.createElement(Log, {
        path: "".concat(x.path, "/*[@id]")
      }), /*#__PURE__*/React.createElement(Keywords, {
        path: "".concat(x.path, "/kw")
      })));
    });
  ...
  var getSuiteInfo = function getSuiteInfo(el) {
    ...
    var result = {
      ...
      status: (status === null || status === void 0 ? void 0 : status.getAttribute('status')) || 'NULL',
      startTime: parseDate(status === null || status === void 0 ? void 0 : status.getAttribute('starttime')),
      endTime: parseDate(status === null || status === void 0 ? void 0 : status.getAttribute('endtime'))
    };
    return result;
  };
  ...
  var TestsTable = function TestsTable() {
    ...
    var data = react.exports.useMemo(function () {
      ...
      while (node) {
        ...
        var subRows = [];
        var subSuite = doc.evaluate("/robot/suite[@id='".concat(item.id, "']/suite"), doc);
    ...
    var columns = react.exports.useMemo(function () {
      return [{
        ...
        Header: function Header(_ref) {
          ...
          return /*#__PURE__*/React.createElement("span", getToggleAllRowsExpandedProps(), isAllRowsExpanded ? '👇' : '👉');
        },
        Cell: function Cell(_ref2) {
          ...
          return (// Use the row.canExpand and row.getToggleRowExpandedProps prop getter
            ...
            row.canExpand ? /*#__PURE__*/React.createElement("span", row.getToggleRowExpandedProps({
              className: "ms-".concat(row.depth * 2)
            }), row.isExpanded ? '👇' : '👉') : null
          );
        }
      }, {
        ...
        Cell: function Cell(_ref3) {
          ...
          return /*#__PURE__*/React.createElement("a", {
            href: "#".concat(row === null || row === void 0 ? void 0 : row.original.id),
            className: "link-info",
            onClick: function onClick() {
              return setLogId(row === null || row === void 0 ? void 0 : row.original.id);
            }
          }, value);
        }
      }, {
        ...
        Cell: function Cell(_ref4) {
          ...
          return /*#__PURE__*/React.createElement("span", {
            className: "fw-bold text-".concat(STATUS_COLORS[value])
          }, value);
        }
      }, {
        Header: 'Elapsed',
        ...
        Header: 'Start / End',
        accessor: function accessor(row) {
          return /*#__PURE__*/React.createElement("small", null, formatDate(row.startTime), /*#__PURE__*/React.createElement("br", null), formatDate(row.endTime));
        }
      }];
    }, [setLogId]);
    ...
    }, reactTable.exports.useSortBy, reactTable.exports.useExpanded),
        getTableProps = _useTable.getTableProps,
        getTableBodyProps = _useTable.getTableBodyProps,
        headerGroups = _useTable.headerGroups,
        rows = _useTable.rows,
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("tr", headerGroup.getHeaderGroupProps(), headerGroup.headers.map(function (column) {
        return /*#__PURE__*/React.createElement("th", column.getHeaderProps(column.getSortByToggleProps()), column.render('Header'), /*#__PURE__*/React.createElement("span", null, column.isSorted ? column.isSortedDesc ? '👇' : '👉' : ''));
      }));
    })), /*#__PURE__*/React.createElement("tbody", getTableBodyProps(), rows.map(function (row) {
      prepareRow(row);
      return /*#__PURE__*/React.createElement("tr", row.getRowProps(), row.cells.map(function (cell) {
        return /*#__PURE__*/React.createElement("td", cell.getCellProps(), cell.isAggregated ? cell.render('Aggregated') : cell.isPlaceholder ? null : cell.render('Cell'));
      }));
    })))), logId && /*#__PURE__*/React.createElement(Log, {
      root: true,
      path: "//suite[@id=\"".concat(logId, "\"]")
    }));
  };
  ...
  var Main = function Main() {
    ...
    var statisticData = react.exports.useMemo(function () {
      if (!doc) return [];
      var list = [];
    ...
    return /*#__PURE__*/React.createElement(AppContext.Provider, {
      ...
      tab: "statistic",
      setTab: setTab
    }, "Statistic"), /*#__PURE__*/React.createElement(NavItem, {
      activeTab: tab,
      tab: "tests",
      setTab: setTab
    }, "Tests metrics")))), /*#__PURE__*/React.createElement("main", {
      ...
      className: "card"
    }, /*#__PURE__*/React.createElement(StatisticTable, {
      data: statisticData,
      info: info
    }))), /*#__PURE__*/React.createElement(TabPane, {
      activeTab: tab,
      ...
      className: "mt-3 mb-4"
    }, "Tests"), /*#__PURE__*/React.createElement(TestsTable, null))))));
  };

  var domContainer = document.querySelector('#root');
  ReactDOM.render( /*#__PURE__*/React.createElement(Main), domContainer); // (function () {
  //   feather.replace();
  //   // Graphs
